...
m6502::s32 m6502::CPU::Execute(s32 Cycles, Mem &memory) {
    ...
    auto LoadRegister = [&Cycles, &memory, this]
    ...
    *	Setting bits 4 & 5 on the stack */
    auto PushPSToStack = [&Cycles, &memory, this]() {
        ...
        PushByteToStack(Cycles, PSStack, memory);
    };
